...
4. Download [CSV](https://github.com/cdl-geneseo/r/blob/main/data_files/phrases.csv) and [XLSX](https://github.com/cdl-geneseo/r/blob/main/data_files/negations.xlsx) files to use during workshop
